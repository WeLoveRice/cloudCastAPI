...
def auto_merge(datasets):
    ...
    if isinstance(datasets, str):
        ...
        print(file_list)
        datasets = [f'{datasets}/{file_name}' for file_name in file_list]
    ...
    if isinstance(datasets[0], str):
        ...
        datasets = [xr.open_dataset(path, chunks={}, engine='cfgrib') for path in datasets]
...
test_model = auto_merge('noaa_model')
